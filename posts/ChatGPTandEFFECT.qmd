...
Sys.setenv("RETICULATE_PYTHON" = "C:\\Users\\mshar\\AppData\\Local\\Programs\\Python\\Python313\\python.exe")
...
with contextlib.redirect_stdout(open(os.devnull, 'w')), contextlib.redirect_stderr(open(os.devnull, 'w')): 
  # Fetch the historical data for the last 5 years 
  data = yf.download(tickers, start='2019-11-26', end='2024-11-24',auto_adjust=False)['Adj Close']
